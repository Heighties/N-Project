...
const Contact = () => {
  return (
    <div className="flex flex-col justify-center items-center w-full h-full relative [perspective:1000px]">
      <h2 className="font-bold text-black sm:text-6xl md:text-4xl">Me contacter</h2>
      <div className="p-8 rounded-lg w-[80%]">
        
        {/* Formulaire de contact */}
        <form className='flex flex-col items-center'>
          <div className='flex items-center sm:items-center md:items-center lg:items-center xl:items-stretch flex-col sm:flex-col md:flex-col lg:flex-col xl:flex-row w-full gap-24'>
          ...
          <button type="submit" className="bg-black text-white border-2 border-white font-bold py-2 px-4 mt-10 w-1/6 rounded-full">Envoyer</button>
        </form>
      </div>
      <div className="flex flex-row mt-4">
            <FaVimeo className=" mr-4 size-10" />
            <FaTwitter className=" mr-4 size-10" />
            <FaInstagram className=" mr-4 size-10" />
            <FaLinkedin className=" mr-4 size-10" />
