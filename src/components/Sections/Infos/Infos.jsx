...
const Infos = () => {
  return (
    <div className="w-full flex p-4">
      <div className="flex sm:flex-col md:flex-col lg:flex-col xl:flex-row sm:items-center md:items-center lg:it ems-center xl:items-stretch sm:gap-12 md:gap-12 lg:gap-12 xl:gap-0 w-full">
        <div className='md:w-1/2'>
        <img src={process.env.PUBLIC_URL + "/photoP2.jpg"} alt="Profile" className="sm:w-96 sm:h-96 md:w-96 md:h-96 lg:w-96 lg:h-96 xl:w-full xl:h-full object-cover" />
        </div>
        <div className="flex flex-col gap-2 w-full">
          ...
          <div className="flex flex-col gap-4 items-center flex-grow p-4 xl:p-0">
            <div className="w-full h-1 bg-black"></div>
            <p className="text-justify ml-4 text-xs sm:text-2xl md:text-base xl:text-sm xl:text-md 2xl:text-md">
