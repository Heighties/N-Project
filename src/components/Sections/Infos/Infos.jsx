...
const Infos = () => {
  return (
    <div className="w-full flex p-4">
      <div className="flex flex-col lg:flex-row items-center sm:items-center lg:items-stretch gap-2 md:gap-0 w-full md:mt-24 lg:mt-auto">
        ...
        <div className="flex flex-col gap-2 w-full md:w-2/3">
          ...
          <div className="flex flex-col gap-4 items-center flex-grow p-4 md:p-0">
            ...
            <p className="text-justify ml-4 text-xs md:text-xs xl:text-lg">
...
Merci de votre visite et au plaisir de collaborer sur vos futurs projets vidéo !
            ...
            <div className="mt-auto md:-mt-0 xl:mt-auto mb-4 md:mb-0 xl:mb-4">
